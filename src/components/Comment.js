...
const Comment = ({ comment, deleteComment, replyToComment, isReply, username }) => {
            ...
            <div style={{
                ...
                <div className="chat-footer text-black opacity-70 underline flex gap-2">
                    ...
                    <div style={{
                        ...
                        <div tabIndex={0} role="button" className={`m-1 ${isAuthor ? "block" : "hidden"}`}><span className='underline'>Edit</span></div>
