   ...
   await fetch(`/api/users/updateProfileData`, {
    ...
    .then(data => {
      ...
      if (data.type == "success") {
        ...
        var verification = jwt.decode(data.token, process.env.NEXT_PUBLIC_JWT_TOKEN);
        console.log(verification)
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="text-center my-10 text-white font-bold text-3xl">Profile Settings</h1>
        ...
        >
         <div className="avatar">
                <div className="w-24 rounded-full ring ring-error ring-offset-base-100 ring-offset-2">
                  <img src={Avatar==""?`https://ui-avatars.com/api/?name=${firstName} ${lastName}`:Avatar} />
                </div>
              </div>
        </span>
      </label>
              ...
              <div className="ml-10">
              <h1 className="text-white text-3xl font-bold">{userData?.firstName} {userData?.lastName}</h1>
